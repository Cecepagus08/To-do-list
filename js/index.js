let editIndex = -1;
let inputCatatan = document.getElementById("inputCatatan input");
let inputJudul = document.getElementById("inputJudul input");
let listCatatan = document.querySelector(".listCatatan");
let modalTitle = document.getElementById("modalCatatan");
...
function editListBtn(button) {
  modalTitle.innerText = "Edit Task"; // Ubah judul modal menjadi "Edit Task"
...
input.forEach(kolomInput => {
  kolomInput.classList.toggle("bg-dark-subtle");
  kolomInput.classList.toggle("bg-light-subtle");
});
